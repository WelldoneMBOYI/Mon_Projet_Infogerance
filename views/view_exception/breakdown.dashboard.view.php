...
<body>
    <main id="main" class="main">
        <section class="pagetitle maForm">
            <div class="card-body ">
                <h5 class="card-title">Les pannes recentes</h5>
                <table class="table table-borderless datatable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>HP EliteBook</td>
                            <td><a href="#" class="text-primary">Probleme de SO</a></td>
                            <td>Neuf</td>
                            <td><span class="badge bg-success">Resolu</span></td>
                        </tr>
                        <tr>
                            <th scope="row"><a href="#">#2644</a></th>
                            <td>HP ProBook</td>
                            <td><a href="#" class="text-primary">Probleme de la carte RX</a></td>
                            <td>Anncien</td>
                        ...
                        <tr>
                            <th scope="row"><a href="#">#2644</a></th>
                            <td>Mac iOs</td>
                            <td><a href="#" class="text-primary">Probleme de baterie</a></td>
                            <td>Nouveau</td>
                            <td><span class="badge bg-success">Résolu</span></td>
                        </tr>
                        <tr>
